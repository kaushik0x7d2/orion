...
This document describes the systematic hardening of [Orion](https://github.com/baahl-nyu/orion), an ASPLOS'25 Best Paper Award-winning Fully Homomorphic Encryption (FHE) framework for deep learning inference. We identified and fixed **8 vulnerabilities**, added **8 production features**, and validated correctness across **2 medical inference models** with **51 automated tests**.
